...
private:
	...
	*/
	...
	complexVector_t* GetLongTermFadingOmni (Ptr<BeamformingParams> bfParams) const;
	/**
	...
	*/
    ...
    Ptr<SpectrumValue> GetChannelGainVectorOmni (Ptr<const SpectrumValue> txPsd, Ptr<BeamformingParams> bfParams, double speed) const;
    Ptr<SpectrumValue> GetChannelGainVectorOmniDownlink (Ptr<const SpectrumValue> txPsd, Ptr<BeamformingParams> bfParams, double speed) const;
	/**
