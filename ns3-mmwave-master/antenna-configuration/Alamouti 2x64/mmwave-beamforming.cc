...
//Number of antennas for Alamouti scheme
uint32_t txAntennaSizeAlamouti = 2; //2 antennas
uint32_t rxAntennaSizeAlamouti = 64; //64 antenas
...
{
	rxAntennaSizeAlamouti = 64; //antenas no receptor eNB (uplink)
