...
public:
	...
	void StartRxCtrl (Ptr<MmWaveSpectrumSignalParametersDlCtrlFrame> params); //Alterei aqui
	...
	bool StartTxDlControlFrames (Ptr<PacketBurst> pb, std::list<Ptr<MmWaveControlMessage> > ctrlMsgList, Time duration, uint8_t slotInd); // control frames from enb to ue
